...
# Set Cursor Theme
gsettings set org.gnome.desktop.interface cursor-theme 'breeze-cursors'
...
./WhiteSur-icon-theme-master/install.sh > /dev/null
...
sudo ./WhiteSur-gtk-theme-master/tweaks.sh -g -i simple -c dark -b blank > /dev/null && echo "Lockscreen theme set..." || echo "Lockscreen theme failed to install!"
...
./WhiteSur-gtk-theme-master/install.sh --normal -c dark -o normal -i simple > /dev/null
